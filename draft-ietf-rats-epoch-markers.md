...
The `etime` rule shown in the CDDL above is importing the definition from "useful CDDL" in {{Section 6 of -CBOR-ETIME}}; RFC 9581 remains the authoritative specification of CBOR tag 1001, which this document does not update or redefine.
